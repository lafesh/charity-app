...
class CharitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charity" do
    assert_difference('Charity.count') do
      post charities_url, params: { charity: { category: @charity.category, description: @charity.description, name: @charity.name, rate: @charity.rate } }, as: :json
    end
  ...
  test "should update charity" do
    patch charity_url(@charity), params: { charity: { category: @charity.category, description: @charity.description, name: @charity.name, rate: @charity.rate } }, as: :json
    assert_response 200
  end
